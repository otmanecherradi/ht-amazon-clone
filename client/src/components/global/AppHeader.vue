<template>
  <div class="grow hidden w-full md:block md:w-auto" id="mobile-menu">
    <ul class="flex justify-center flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
      <li>
