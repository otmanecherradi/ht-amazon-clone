<template>
<div class="grow block p-6 rounded-lg shadow-lg bg-white w-full">
  ...
  <div v-if="msg!=null" class="p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800" role="alert">
